...
export default class FV extends Component {
    constructor() {
        super();
        this.state = {
            queryObj: {},
    ...
    async getParams() {
        let FV = +document.getElementById("inputStartingAmount").value;
    ...
    async getRequest(){
        ...
        request.post(
            'http://localhost:5000/materials/instruments/FV',
            {
            ...
            return (
                <div className="instrument-content">
                    <div className="form-group">
                        <label for="inputStartingAmount">Текущая стоимость</label>
                        <input type="number" className="form-control" id="inputStartingAmount" placeholder="Введите текущую стоимость" required="required" step="0.01" />
                    </div>
                    <div className="form-group">
